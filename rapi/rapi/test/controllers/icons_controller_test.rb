...
class IconsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create icon" do
    assert_difference('Icon.count') do
      post icons_url, params: { icon: { cap1: @icon.cap1, cap2: @icon.cap2, icon: @icon.icon, name: @icon.name, num1: @icon.num1, num2: @icon.num2 } }, as: :json
    end
  ...
  test "should update icon" do
    patch icon_url(@icon), params: { icon: { cap1: @icon.cap1, cap2: @icon.cap2, icon: @icon.icon, name: @icon.name, num1: @icon.num1, num2: @icon.num2 } }, as: :json
    assert_response 200
  end
